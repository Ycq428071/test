  ...
  <div class="gl-form_container">
    <el-form ref="form" :model="form" :rules="rules" label-width="125px" inline>
      <el-form-item label="工资年月" prop="payday">
        <el-date-picker v-model="form.payday" type="month" placeholder="请选择工资年月" style="width: 100%;"
          value-format="yyyy-MM" :disabled="form.id !== null" :editable="false" :clearable="false">
        </el-date-picker>
      </el-form-item>
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id !== null) {
            ...
            addSalary({ ...this.form, ...this.comForm }).then(response => {
