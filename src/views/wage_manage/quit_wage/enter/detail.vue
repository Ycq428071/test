  ...
  <div class="app-container">
    <div class="gl-body">
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            @click="$router.push('/wage_manage/quit_wage/qw_enter-add/index/' + $route.params.securityId + '/0')"
          >
            新增
          </el-button>
        </el-col>
      ...
      >
        ...
        <el-table-column label="证件号码" align="center" prop="certificateNumber" width="170" />
        ...
        <el-table-column label="制表日期" align="center" prop="createDate" width="100" />
        <el-table-column label="制表人" align="center" prop="createUserName" />
        <el-table-column label="复核日期" align="center" prop="checkDate" width="100" />
        ...
        <el-table-column label="操作" align="center" fixed="right" width="100">
          <template slot-scope="scope">
            <el-button
              ...
              type="text"
              v-hasPermi="['']"
              @click="$router.push('/wage_manage/quit_wage/qw_enter-update/index/' + $route.params.securityId + '/' + scope.row.id + '?row=' + JSON.stringify(scope.row))"
            >
              修改
            </el-button>
            <el-button
