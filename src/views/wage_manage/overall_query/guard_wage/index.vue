  ...
  <div class="app-container">
    ...
    <div class="gl-body">
      <el-row :gutter="10" class="mb8">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            icon="el-icon-download"
            @click="handleExport"
            v-hasPermi="['salary:employee:exportStaffSalary']"
          >导出</el-button>
        </el-col>
      </el-row>
      ...
      >
        ...
        <el-table-column label="手机" align="center" prop="phoneNumber" width="110" show-overflow-tooltip />
      </el-table>
...
<script>
import { listWage } from "@/api/wage_manage/overall_query"
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.download('/salary/employee/exportStaffSalary', {
        ...exportParams
