    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" class="gl-search_form">
      ...
      >
        <el-form :model="queryParams" ref="queryFormMore" :inline="true" class="gl-search_form">
          ...
          <el-form-item label="照片" prop="isPhoto">
            <el-select v-model="queryParams['isPhoto']">
              <el-option label="全部" :value="null"></el-option>
              <el-option
                v-for="item in dict.type['query_guard_photo']"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <el-form-item label="户籍性质" prop="domicile">
            <el-select v-model="queryParams['domicile']">
              <el-option label="全部" :value="null"></el-option>
              <el-option
                v-for="item in dict.type['domicile']"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <el-form-item label="养老保险" prop="endowmentInsurance">
            <el-select v-model="queryParams['endowmentInsurance']">
              <el-option label="全部" :value="null"></el-option>
              <el-option
                v-for="item in dict.type['endowmentinsurance']"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <el-form-item label="终止合同起始日期" prop="contractStartDate">
            <el-date-picker
          ...
          <el-form-item label="终止合同终止日期" prop="contractEndDate">
            <el-date-picker
          ...
          <el-form-item label="试用结束起始日期" prop="trialStartDate">
            <el-date-picker
          ...
          <el-form-item label="试用结束终止日期" prop="trialEndDate">
            <el-date-picker
